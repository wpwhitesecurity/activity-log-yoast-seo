...
$custom_alerts = array(
	__( 'Yoast SEO', 'wsal-yoast' ) => array(
		__( 'Post Changes', 'wsal-yoast' )            => array(
			...
			array( 8807, WSAL_INFORMATIONAL, __( 'User changed the focus keyword of a post', 'wsal-yoast' ), __( 'Changed the focus keyword for the post %PostTitle% %LineBreak% ID: %PostID% %LineBreak% Type: %PostType% %LineBreak% Status: %PostStatus% %LineBreak% Previous keyword: %1$old_keywords% %LineBreak% New keyword: %new_keywords% %LineBreak% %EditorLinkPost%', 'wsal-yoast' ), 'yoast-seo-metabox', 'modified' ),
