	...
	__( 'Yoast SEO', 'activity-log-wp-seo' ) => array(
		...
		__( 'Plugin Settings Changes', 'activity-log-wp-seo' ) => array(
			...
			array(
				...
				__( 'A <strong>%redirect_type%</strong> plain redirect for the URL <strong>%old_url% </strong> was deleted.', 'activity-log-wp-seo' ),
				array(),
				array(),
				'yoast-seo-redirects',
				'deleted',
			...
			array(
				...
				__( 'A <strong>%redirect_type%</strong> regex redirect for the URL <strong>%old_url% </strong> was deleted.', 'activity-log-wp-seo' ),
				array(),
				array(),
				'yoast-seo-redirects',
				'deleted',
