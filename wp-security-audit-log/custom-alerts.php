	...
	__( 'Yoast SEO', 'activity-log-wp-seo' ) => array(
		...
		__( 'Plugin Settings Changes', 'activity-log-wp-seo' ) => array(
			...
			array(
				8855,
				WSAL_MEDIUM,
				__( 'A new plain / regex redirect was added', 'activity-log-wp-seo' ),
			...
			array(
				8856,
				WSAL_MEDIUM,
				__( 'A plain / regex redirect was modified', 'activity-log-wp-seo' ),
			...
			array(
				8857,
				WSAL_MEDIUM,
				__( 'A plain / regex redirect was deleted', 'activity-log-wp-seo' ),
